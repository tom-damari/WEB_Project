...
const phoneInput = document.querySelector('#form-signIn input[name="ILphone"]')
...
const onSignInSubmit = (e) => {
    ...
    if (errorMessage) { // if there is a wrong input then show error message
        ...
        // success massage
        msg.innerHTML = '!בדיקת ולידציה הושלמה בהצלחה';
        ...
        // now after passing the signin validation check - submit the form
        signInForm.submit();
    }
};
